...
#endif
        //Not sure what this inititates
        HAL_Init( );

        SystemClockConfig( );

        //Initiates UART (may be used by GPS)
...
//***Deinitiates the Microcontroller stuff. May be useful to save power
...
{
    return BATTERY_POWER;  // USB_POWER BATTERY_POWER
}
